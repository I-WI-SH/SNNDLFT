...
MODEL_TYPE_TO_PEFT_MODEL_MAPPING: dict[str, type[SNNPeftModel]] = {
...
def ada_get_peft_model(
    ...
    if peft_config.task_type not in MODEL_TYPE_TO_PEFT_MODEL_MAPPING.keys() and not peft_config.is_prompt_learning:
        return SNNPeftModel(model, peft_config, adapter_name=adapter_name, autocast_adapter_dtype=autocast_adapter_dtype)
