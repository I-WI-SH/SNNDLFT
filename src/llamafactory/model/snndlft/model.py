    ...
    **Attributes**:
    ...
    def update_and_allocate(self, global_step):
        ...
        if global_step < lora_config.total_step - lora_config.tfinal:
            _, rank_pattern, layers_firing_rate, layers_ipt, combined_ipt_layers = self.rankallocator.update_and_allocate(self.model, global_step)
            if rank_pattern:
                lora_config.rank_pattern = rank_pattern
            return layers_firing_rate, layers_ipt, combined_ipt_layers,rank_pattern
        # Finalize the budget allocation
        elif global_step == lora_config.total_step - lora_config.tfinal:
            _, rank_pattern, layers_firing_rate, layers_ipt, combined_ipt_layers = self.rankallocator.update_and_allocate(self.model, global_step, force_mask=True)
